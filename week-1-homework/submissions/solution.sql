...
SELECT * FROM cars_data ORDER BY accelerate DESC LIMIT 1;
...
SELECT * FROM car_makers WHERE maker LIKE 'a%r';
...
SELECT COUNT(*) FROM cars_data WHERE cylinders > 6 AND
weight BETWEEN 3000 AND 4000 AND year NOT IN(1970,1975,1981);